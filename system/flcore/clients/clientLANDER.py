...
class clientLANDER(Client):
    ...
    """
    # def __init__(self, args, id, train_samples, test_samples=None, **kwargs):  
    ...
    def _ensure_anchors(self):
        ...
        if hasattr(self.train_data, "classes"):
            class_names = list(self.train_data.classes)
        else:
    ...
    def train(self):
        ...
        loader = DataLoader(self.train_data, batch_size=self.batch_size, shuffle=True, num_workers=0)
