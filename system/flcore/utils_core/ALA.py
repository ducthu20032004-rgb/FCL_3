...
class ALA:
    ...
    def adaptive_local_aggregation(self, 
        ...
        while True:
            ...
            loss_epoch = np.mean(losses[-len(rand_loader):])
            
            # if wandb.run is not None and self.cid == 1:
            #     print("Debug - Client:",self.cid,"Epoch:",cnt,"Loss:",loss_epoch)
            #     wandb.log({
            #     f"ALA/client_{self.cid}/loss_epoch": loss_epoch,
            #     "ALA/epoch": cnt
            # })
