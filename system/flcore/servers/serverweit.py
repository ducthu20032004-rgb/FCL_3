            ...
            for i in range(self.global_rounds):
                ...
                for client in self.selected_clients:
                    ...
                    try:
                        ...
                        if client.id in [0]:  
                            try:
                                save_dir =  "/home/ghostm211/Thu/FCL_3/weight_fedweit/weight_client_round"  # Thay đổi đường dẫn theo nhu cầu
                ...
                #     csv_path = "/home/ghostm211/Thu/FCL_3/drift_results.csv"
